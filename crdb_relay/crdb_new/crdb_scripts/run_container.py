...
./share/crdb_new/cockroach workload init kv \
'postgresql://root@35.76.59.55:26257?sslmode=disable' \
...
--duration=1m \
'postgresql://root@35.76.59.55?sslmode=disable' \
--concurrency 1000
...
./share/crdb_new/cockroach workload init movr 'postgresql://root@35.76.59.55:26257?sslmode=disable'

./share/crdb_new/cockroach workload run movr --duration=3m 'postgresql://root@35.76.59.55:26257?sslmode=disable'

./share/crdb_rls/cockroach workload init ycsb \
...
./share/crdb_new/cockroach workload run ycsb \
--duration=3m \
--concurrency 1000 \
'postgresql://root@roach1:26257?sslmode=disable' 


./share/crdb_new/cockroach workload run ycsb --duration=1m 'postgresql://root@35.76.59.55:26257?sslmode=disable' --concurrency 2000
...
./share/crdb_new/cockroach init --insecure --host=35.76.59.55
cockroach init --insecure --host=103.4.15.248

./share/crdb_new/cockroach sql --insecure --host=35.76.59.55
cockroach sql --insecure --host=103.4.15.248
...
./share/crdb_new/cockroach workload fixtures import tpcc \
--partitions=5 \
--warehouses=20000 \
'postgres://root@35.76.59.55:26257?sslmode=disable'
...
ulimit -n 100000 && ./share/crdb_rls/cockroach workload run tpcc \
--partitions=5 \
--warehouses=13000 \
--ramp=1m \
--duration=3m \
...
ulimit -n 100000 && ./share/crdb_new/cockroach workload run tpcc \
--partitions=5 \
--warehouses=6000 \
--ramp=1m \
--duration=3m \
